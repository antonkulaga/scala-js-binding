...
import scalation.math.Rational._0
 ...
 *  slower, but do not modify the array.  This class is specialized for Rational.
 *  @see `Sorting` for a generic version of this class.
 *  @param a  the array to operate on
 */
class MM_SortingQ (a: MM_ArrayQ)
{
     ...
     */
    def median (p: Int, r: Int, k: Int): Rational =
    {
        if (p == r) return a(p)
     ...
     */
    def median (k: Int = (n+1)/2): Rational = median (0, n-1, k)
     ...
     *  @param k   the type of median (k-th smallest element)
     */
    def imedian (rk: Array [Int], p: Int, r: Int, k: Int): Rational =
    {
     ...
     *  @param k  the type of median (e.g., k = (n+1)/2 is the median)
     */
    def imedian (k: Int = (n+1)/2): Rational =
    {
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MM_SortingQ` companion object provides shortcuts for calling methods from
 *  the `MM_SortingQ` class.
 */
object MM_SortingQ
{
    // Direct median and sorting --------------------------------------------
     ...
     */
    def median (a: MM_ArrayQ, k: Int): Rational = (new MM_SortingQ (a)).median (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort (a: MM_ArrayQ) { (new MM_SortingQ (a)).qsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort (a: MM_ArrayQ) { (new MM_SortingQ (a)).selsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort2 (a: MM_ArrayQ) { (new MM_SortingQ (a)).qsort2 () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort2 (a: MM_ArrayQ) { (new MM_SortingQ (a)).selsort2 () }
     ...
     *  @param a  the array to be examined
     */
    def imedian (a: MM_ArrayQ, k: Int): Rational = (new MM_SortingQ (a)).imedian (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
    def iqsort (a: MM_ArrayQ): Array [Int] = (new MM_SortingQ (a)).iqsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort (a: MM_ArrayQ): Array [Int] = (new MM_SortingQ (a)).iselsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
//  def iqsort2 (a: MM_ArrayQ) { (new MM_SortingQ (a)).iqsort2 () }   // FIX: implement

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort2 (a: MM_ArrayQ): Array [Int] = (new MM_SortingQ (a)).iselsort2 ()
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 // MM_SortingQTest4Test

//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 // MM_SortingQTest5 object
