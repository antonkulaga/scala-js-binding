...
class MM_SortingS (a: MM_ArrayS)
{
     ...
     */
    def median (p: Int, r: Int, k: Int): StrNum =
    {
        if (p == r) return a(p)
     ...
     */
    def median (k: Int = (n+1)/2): StrNum = median (0, n-1, k)
     ...
     *  @param k   the type of median (k-th smallest element)
     */
    def imedian (rk: Array [Int], p: Int, r: Int, k: Int): StrNum =
    {
     ...
     *  @param k  the type of median (e.g., k = (n+1)/2 is the median)
     */
    def imedian (k: Int = (n+1)/2): StrNum =
    {
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MM_SortingS` companion object provides shortcuts for calling methods from
 *  the `MM_SortingS` class.
 */
object MM_SortingS
{
    // Direct median and sorting --------------------------------------------
     ...
     */
    def median (a: MM_ArrayS, k: Int): StrNum = (new MM_SortingS (a)).median (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort (a: MM_ArrayS) { (new MM_SortingS (a)).qsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort (a: MM_ArrayS) { (new MM_SortingS (a)).selsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort2 (a: MM_ArrayS) { (new MM_SortingS (a)).qsort2 () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort2 (a: MM_ArrayS) { (new MM_SortingS (a)).selsort2 () }
     ...
     *  @param a  the array to be examined
     */
    def imedian (a: MM_ArrayS, k: Int): StrNum = (new MM_SortingS (a)).imedian (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
    def iqsort (a: MM_ArrayS): Array [Int] = (new MM_SortingS (a)).iqsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort (a: MM_ArrayS): Array [Int] = (new MM_SortingS (a)).iselsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
//  def iqsort2 (a: MM_ArrayS) { (new MM_SortingS (a)).iqsort2 () }   // FIX: implement

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort2 (a: MM_ArrayS): Array [Int] = (new MM_SortingS (a)).iselsort2 ()
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 // MM_SortingSTest4Test

//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 // MM_SortingSTest5 object
