...
class MM_SortingL (a: MM_ArrayL)
{
     ...
     */
    def median (p: Int, r: Int, k: Int): Long =
    {
        if (p == r) return a(p)
     ...
     */
    def median (k: Int = (n+1)/2): Long = median (0, n-1, k)
     ...
     *  @param k   the type of median (k-th smallest element)
     */
    def imedian (rk: Array [Int], p: Int, r: Int, k: Int): Long =
    {
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MM_SortingL` companion object provides shortcuts for calling methods from
 *  the `MM_SortingL` class.
 */
object MM_SortingL
{
    // Direct median and sorting --------------------------------------------
     ...
     */
    def median (a: MM_ArrayL, k: Int): Long = (new MM_SortingL (a)).median (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort (a: MM_ArrayL) { (new MM_SortingL (a)).qsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort (a: MM_ArrayL) { (new MM_SortingL (a)).selsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort2 (a: MM_ArrayL) { (new MM_SortingL (a)).qsort2 () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort2 (a: MM_ArrayL) { (new MM_SortingL (a)).selsort2 () }
     ...
     *  @param a  the array to be examined
     */
    def imedian (a: MM_ArrayL, k: Int): Long = (new MM_SortingL (a)).imedian (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
    def iqsort (a: MM_ArrayL): Array [Int] = (new MM_SortingL (a)).iqsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort (a: MM_ArrayL): Array [Int] = (new MM_SortingL (a)).iselsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
//  def iqsort2 (a: MM_ArrayL) { (new MM_SortingL (a)).iqsort2 () }   // FIX: implement

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort2 (a: MM_ArrayL): Array [Int] = (new MM_SortingL (a)).iselsort2 ()
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 // MM_SortingLTest4Test

//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 // MM_SortingLTest5 object
