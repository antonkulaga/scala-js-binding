...
class MM_SortingC (a: MM_ArrayC)
{
     ...
     */
    def median (p: Int, r: Int, k: Int): Complex =
    {
        if (p == r) return a(p)
     ...
     */
    def median (k: Int = (n+1)/2): Complex = median (0, n-1, k)
     ...
     *  @param k   the type of median (k-th smallest element)
     */
    def imedian (rk: Array [Int], p: Int, r: Int, k: Int): Complex =
    {
     ...
     *  @param k  the type of median (e.g., k = (n+1)/2 is the median)
     */
    def imedian (k: Int = (n+1)/2): Complex =
    {
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `MM_SortingC` companion object provides shortcuts for calling methods from
 *  the `MM_SortingC` class.
 */
object MM_SortingC
{
    // Direct median and sorting --------------------------------------------
     ...
     */
    def median (a: MM_ArrayC, k: Int): Complex = (new MM_SortingC (a)).median (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort (a: MM_ArrayC) { (new MM_SortingC (a)).qsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort (a: MM_ArrayC) { (new MM_SortingC (a)).selsort () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable sort.
     *  @param a  the array to be sorted
     */
    def qsort2 (a: MM_ArrayC) { (new MM_SortingC (a)).qsort2 () }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable sort.
     *  @param a  the array to be sorted
     */
    def selsort2 (a: MM_ArrayC) { (new MM_SortingC (a)).selsort2 () }
     ...
     *  @param a  the array to be examined
     */
    def imedian (a: MM_ArrayC, k: Int): Complex = (new MM_SortingC (a)).imedian (k)

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, ascending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
    def iqsort (a: MM_ArrayC): Array [Int] = (new MM_SortingC (a)).iqsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, ascending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort (a: MM_ArrayC): Array [Int] = (new MM_SortingC (a)).iselsort ()

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Fast, descending, unstable indirect sort.
     *  @param a  the array to be sorted
     */
//  def iqsort2 (a: MM_ArrayC) { (new MM_SortingC (a)).iqsort2 () }   // FIX: implement

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Slow, descending, stable indirect sort.
     *  @param a  the array to be sorted
     */
    def iselsort2 (a: MM_ArrayC): Array [Int] = (new MM_SortingC (a)).iselsort2 ()
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 // MM_SortingCTest4Test

//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
 // MM_SortingCTest5 object
