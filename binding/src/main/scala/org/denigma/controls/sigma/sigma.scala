...
case class SigmaNode(id:String,label:String,x:Int = Random.nextInt(10),y:Int  = Random.nextInt(10),size:Int = 10) extends SigmaNodeLike
...
object SigmaGraphInit
{
  def empty =SigmaGraphInit(List.empty[SigmaNode],List.empty[SigmaEdge])
}
