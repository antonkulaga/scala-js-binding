...
*/
  ...
  implicit class SeqWatcher[T](col:Rx[Seq[T]]) extends WatcherBase[T,Seq[T]](col)
   ...
   * @tparam T
   */
  class WatcherBase[T,Col<:Seq[T]](col:Rx[Col])
  {
 ...
 */
case class CollectionUpdate[T](removed:Seq[T],inserted:Seq[T],moved:List[Moved[T]] = List.empty)
