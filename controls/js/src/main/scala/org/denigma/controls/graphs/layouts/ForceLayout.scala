package org.denigma.controls.graphs.layouts


trait ForceLayout extends GraphLayout
{

  lazy val width:Double = 1000
  lazy val height:Double = 1000
  lazy val attractionMult:Double =  10 /*4*/
  lazy val repulsionMult:Double =  0.6 /*0.4*/
