...
object ModelMessages extends ExtendedStorageProtocol
{
  ...
  case class SelectQuery(channel:String,shapeId:Res,query:Res, id:String ,time:Double , context:Option[IRI] = None) extends ModelMessage

  case class Create(channel:String,shapeId:Res,models:Set[PropertyModel],rewriteIfExists:Boolean = true, id:String ,time:Double  , context:Option[IRI] = None) extends ModelMessage

  case class Read(channel:String,shapeId:Res,resources:Set[Res], id:String ,time:Double , context:Option[IRI] = None ) extends ModelMessage

  case class Update(channel:String,shapeId:Res,models:Set[PropertyModel],createIfNotExists:Boolean = true, id:String ,time:Double , context:Option[IRI] = None ) extends ModelMessage

  case class Delete(channel:String,shape:Res,res:Set[Res], id:String ,time:Double  , context:Option[IRI] = None)  extends ModelMessage
